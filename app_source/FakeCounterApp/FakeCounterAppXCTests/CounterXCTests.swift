...
final class CounterViewModelLongRunningTests: XCTestCase {
    ...
    func testFullJourney_combinedParts() {
        ...
        XCTAssertEqual(vm.counter, 0, "Expected counter to be back to 0 after increase/decrease")
        XCTAssertGreaterThan(vm.secondsElapsed, 600, "Timer should be running > 10 mins")
